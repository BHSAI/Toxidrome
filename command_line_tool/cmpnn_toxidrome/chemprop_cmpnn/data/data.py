...
import chemprop.data.scaler as scaler
...
class MoleculeDataset(Dataset):
    ...
    def normalize_features(self, scaler: scaler.StandardScaler = None, replace_nan_token: int = 0) -> scaler.StandardScaler:
        """
        ...
        if scaler is not None:
            ...
            self.scaler = scaler.StandardScaler(replace_nan_token=replace_nan_token)
